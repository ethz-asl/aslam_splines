...
BOOST_PYTHON_MODULE(libaslam_splines_python)
{
    ...
    class_< BSplineRSPoseDesignVariable, boost::shared_ptr< BSplineRSPoseDesignVariable > >("BSplineRSPoseDesignVariable", init<const BSplinePose &, double>() )
        .def("spline", &BSplineRSPoseDesignVariable::spline, return_value_policy<copy_const_reference>())
        .def("numDesignVariables", &BSplineRSPoseDesignVariable::numDesignVariables )
        .def("designVariable", &BSplineRSPoseDesignVariable::designVariable, return_internal_reference<>())
        .def("transformation", &BSplineRSPoseDesignVariable::transformation)
        .def("lineDelay", &BSplineRSPoseDesignVariable::lineDelay)
        ;
