...
//		.def("numValidTimeSegments", numValidTimeSegments2, "The number of valid time segments for the current knot sequence")
		.def("addControlVertices", &addControlVertices, "Sets the knots and spline control vertices")
		.def("setControlVertices", &setControlVertices, "Sets the knots and spline control vertices")
...
//		.def("initSpline3", &TSpline::initSpline3, "Initialize the spline to interpolate a set of points")
